...
if __name__ == "__main__":
    ...
    # 固定参数（按需改成你的本地路径/设置）
    ckpt_path = "../../../../../NRS/Improvement/population_based/GFACS/pretrained/cvrp_nls/1000/cvrp1000_sd0_fromckpt-500_cvrp500_sd0_50/20.pt"   # 模型文件路径，或 None
    ...
    # ---------- logger ----------
    result_root = '../../../../../NRS/Improvement/population_based/GFACS/cvrp_nls/survey_results'
    log_path = init_logger(result_root, desc="test_CVRPLIB_Survey")
    logger = logging.getLogger(LOG_NAME)
