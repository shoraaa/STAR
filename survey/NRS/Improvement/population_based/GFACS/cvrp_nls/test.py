...
def main(ckpt_path, n_nodes, k_sparse, size=None, n_ants=100, n_iter=10, guided_exploration=False, seed=0):
    test_list = load_test_dataset_pkl(n_nodes, k_sparse, DEVICE, TAM)
    # test_list, int_dist_list, name_list = load_vrplib_dataset(n_nodes, k_sparse, DEVICE)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--nodes", type=int, default=200, help="Problem scale")
    ...
    args.path = "../../../../../NRS/Improvement/population_based/GFACS/pretrained/cvrp_nls/200/cvrp200_sd0/50.pt"   # 模型文件路径，或 None
