...
if log_root:
    logger_params['log_file']['filepath'] = os.path.join(log_root, 'drhg_tsp_no_finetune')
...
def main():
    ...
    if USE_LIB_MODE:
        if os.environ.get("NRS_EVAL_SIZE_BUCKET") or os.environ.get("NRS_SMOKE"):
            ...
            ranges = [[0, 1000], [1000, 10000], [10000, 100001]]
        tester.run_lib(LIB_PATH, scale_ranges=ranges)  # 按需设区间
