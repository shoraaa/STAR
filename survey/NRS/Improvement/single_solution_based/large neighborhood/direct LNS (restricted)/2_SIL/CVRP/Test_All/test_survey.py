...
if log_root:
    logger_params['log_file']['filepath'] = os.path.join(log_root, 'sil_prc_cvrp')
...
def main_test(path,prob_size, PRC, repair_max_sub_length, budget, random_insertion):
    ...
    if prob_size==-1:
        ...
        env_params['vrplib_path'] = os.environ.get('NRS_SURVEY_CVRP_DIR', b2 + datas[prob_size][0])
        env_params['data_path'] = env_params['vrplib_path']
