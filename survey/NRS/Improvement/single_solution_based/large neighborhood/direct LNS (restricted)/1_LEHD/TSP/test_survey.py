...
RRC_budget = int(os.environ.get("NRS_LEHD_RRC_BUDGET", "1" if os.environ.get("NRS_SMOKE") else "1000"))         # RRC budget
...
if os.environ.get("NRS_EVAL_SIZE_BUCKET") or os.environ.get("NRS_SMOKE"):
    scale_ranges = [[
        int(os.environ.get("NRS_SURVEY_SIZE_LOW", "0")),
        int(os.environ.get("NRS_SURVEY_SIZE_HIGH", "100001")),
    ]]
else:
...
if log_root:
    logger_params['log_file']['filepath'] = os.path.join(log_root, 'lehd_rrc_tsp')
