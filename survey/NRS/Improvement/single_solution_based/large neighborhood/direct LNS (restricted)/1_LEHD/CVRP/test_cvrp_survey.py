...
from CVRP.Tester_inCVRPlib import VRPTester as Tester
...
test_paras = {
   # problem_size: [filename, episode, batch]
    ...
    0: ['vrplib_192instances.txt', 262, 1, 0 ]
}
...
if log_root:
    logger_params['log_file']['filepath'] = os.path.join(log_root, 'lehd_rrc_cvrp')
