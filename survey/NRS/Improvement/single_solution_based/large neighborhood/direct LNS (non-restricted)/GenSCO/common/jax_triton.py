...
"""Module for calling Triton kernels from JAX. Modified for personal use."""
...
PTX_VERSION: int | None = 81   # e.g. ptx isa 81 for cuda12.1, ptx isa 78 for cuda11.8
                               # if None, triton will automatically select ptx version, for triton==3.0.0 it's 84
if os.environ.get('PTX_VERSION') is not None:
  PTX_VERSION = eval(os.environ.get('PTX_VERSION'))
else:
  ...
  # TODO: check compatibility between cuda and ptx
