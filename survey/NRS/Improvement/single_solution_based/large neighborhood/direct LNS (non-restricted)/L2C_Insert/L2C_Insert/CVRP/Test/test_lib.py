...
mode = 'test'
test_paras = {
    0: ['vrplib_instances_set_X.txt', 110, 1, 0]
}
...
if log_root:
    logger_params['log_file']['filepath'] = os.path.join(log_root, 'l2c_iter_cvrp')
...
def main_test(path, args, file_name, use_RRC=None):
    ...
    env_params['vrplib_path'] = os.environ.get(
        'NRS_SURVEY_CVRP_DIR',
...
if __name__ == "__main__":
    ...
    coords_norms = [0]
    knearest_ifs = [0]
    rrc_ranges = [1] if os.environ.get("NRS_SMOKE") else [1000]
