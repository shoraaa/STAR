...
def _setup_logger_and_result_dir(args):
    ...
    base_dir = os.path.join(log_root, "fastt2t_tsp") if log_root else "./result_survey_tsp"
...
if __name__ == "__main__":
    ...
    smoke = bool(os.environ.get("NRS_SMOKE"))
    ...
    args = Namespace(
        ...
        use_tsplib=True,
        # tsplib_dir='../../../../../../0_data_survey/survey_bench_tsp_small_example',
        tsplib_dir=survey_tsp_dir,
        tsplib_opt_file=None,
        tsplib_opt_map=tsplib_cost,
        test_split="./data/tsplib/tsp",

        # !
        inference_diffusion_steps=1 if smoke else 10,
        two_opt_iterations=0,
        ckpt_path="./model/tsp100.ckpt",
        rewrite_steps=1 if smoke else 10,
        sparse_factor=-1,
        # sparse_factor=50,
        ...
        num_workers=0 if smoke else 64,
        fp16=False,
