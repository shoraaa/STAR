...
class Actor(nn.Module):
    ...
    # ! 修改的代码
    # ! generalize CPEs to new size
    def reset_CPE_size(self, new_size):
        self.embedder.pattern = self.embedder.cyclic_position_encoding_pattern(new_size, self.embedding_dim)
