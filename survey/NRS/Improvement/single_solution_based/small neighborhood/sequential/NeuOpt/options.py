...
def get_options(args=None):
    ...
    parser.add_argument('--val_batch_size', type=int, default=10000, help='Number of instances per batch used for reporting validation performance')
    # parser.add_argument('--val_dataset', type=str, default = None, help='Dataset file to use for validation')
    parser.add_argument('--val_dataset', type=str, default = 
                        '../../../../../../0_data_survey/survey_synthetic_tsp/test_tsp100_n10000_lkh.txt', help='dataset file path')
    ...
    parser.add_argument('--T_max', type=int, default=10000, help='number of steps to swap')
...
'''
nohup python -u neuopt_run_synthetic.py --eval_only --no_saving --no_tb --init_val_met random --k 4 --val_m 1 --stall 10 > neuopt_tsp100_eval.log 2>&1 &
