...
def get_options(args=None):
    ...
    parser.add_argument('--dummy_rate', type=float, default=0.2, help="add DUMMY_RATE * graph_size nodes as dummy depots (for CVRP only)") # see Jupyter Notebook for example use
    ...
    parser.add_argument('--T_max', type=int, default=10000, help='number of steps for inference')
    parser.add_argument('--eval_only', action='store_true', help='switch to inference mode')
    parser.add_argument('--val_size', type=int, default=10000, help='number of instances for validation/inference')
    parser.add_argument('--eval_batch_size', type=int, default=5000, help='batch size for validation/inference')
    parser.add_argument('--val_dataset', type=str, default = '../../../../../../0_data_survey/survey_synthetic_tsp/test_tsp100_n10000_lkh.txt', help='dataset file path')
    parser.add_argument('--val_m', type=int, default=1, help='number of data augments (<=8)')
    parser.add_argument('--lib_model', action='store_true', help='use TSPLIB dataset for validation')
