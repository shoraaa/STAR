...
class CVRPEnv:
    ...
    def load_vrplib_problem(self, instance, aug_factor=1, aug_idx=-1):
        ...
        # ! 保证3维，兼容2维
        if depot.dim() == 2:           # (batch, 2) -> (batch, 1, 2)
    ...
    def load_problems(self, batch_size, aug_factor=1):
        ...
        if aug_factor > 1:
            if aug_factor == 8:
                ...
                raise NotImplementedError
        print(f"aug factor: {aug_factor}, batch size: {self.batch_size}")
    ...
    def reset(self):
        ...
        print(f"problem_size: {self.problem_size}, multi_width: {self.multi_width}")
