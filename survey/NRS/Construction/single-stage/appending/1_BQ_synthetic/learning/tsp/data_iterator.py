...
from learning.tsp.dataloading.dataset import load_dataset,load_dataset_txt
...
class DataIterator:
    ...
    def __init__(self, args: Namespace):
        ...
        if args.test_dataset.lower().endswith(".tsp"):
            self.test_trajectories = load_dataset(args.test_dataset, args.test_batch_size, False, "test")
        elif args.test_dataset.lower().endswith(".txt"):
            self.test_trajectories = load_dataset_txt(args.test_dataset, args.test_batch_size, False, "test", episode=args.episode)
        else:
            raise NotImplementedError("Only .tsp and .txt datasets are supported for testing.")
