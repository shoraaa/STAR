...
sys.path.insert(0, "../..")
import logging
from utils.utils import create_logger, copy_all_src, tsplib_collections, parse_tsplib_name, load_tsplib_file, normalize_nodes_to_unit_board, choose_bsz, calculate_tour_length_by_dist_matrix, get_dist_matrix, avg_list
...
def main():
    ...
    # ! 补充文件读取地址变量
    bench_path = "../../../../../../0_data_survey/survey_bench_tsp"
    ...
    for i in range(len(tsplib_names)):
        ...
        # prepare env
        instance, _ = load_tsplib_file(Path(bench_path), name)
