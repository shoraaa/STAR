...
def parse_log_file(file_path):
    ...
    # [2025-10-13 01:06:50] test_survey.py(308) : Instance: national_wi29: Size: 29, Score: 28191.0, Gap: 2.130%, Time: 1.33s
...
def get_bucket_stats(results):
    # original buckets from test_survey.py logic
    # [0, 1000)
    # [1000, 10000)
    # [10000, 100000]
...
def main():
    log_file = "../../../../../../NRS/Construction/single-stage/appending/8_DGL/TSP/result_survey_tsp/20251013_010646_test_TSPLIB_Survey/run_log.txt"
