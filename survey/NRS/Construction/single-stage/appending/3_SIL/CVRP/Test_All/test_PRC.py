...
import logging
from SIL_main.utils.utils import create_logger, copy_all_src

from SIL_main.CVRP.Test_All.Tester import VRPTester as Tester
...
if __name__ == "__main__":
    ...
    for prob_size in [-1]: # 1000, 5000, 10000, 50000, 100000
