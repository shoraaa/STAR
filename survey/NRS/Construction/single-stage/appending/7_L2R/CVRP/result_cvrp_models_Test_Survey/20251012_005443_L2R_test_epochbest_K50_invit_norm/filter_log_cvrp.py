...
def parse_log(file_path):
    ...
    with open(file_path, 'r') as f:
        for line in f:
            ...
            # [2025-10-12 00:54:44] CVRPTester_LIB_Survey.py(173) : Instance name: X-n120-k6, problem_size: 119
            ...
            # Match Aug gap
            # [2025-10-12 00:54:45] CVRPTester_LIB_Survey.py(243) : Aug score:14287.000, Aug gap:7.163%
...
def main():
    # Use the directory of the script to find run_log.txt
